...
envValue=$(kubectl exec -it $(kubectl get pods | grep sokos-trekk | cut -f1 -d' ') -c sokos-trekk -- env | egrep "^AZURE|^OB04_TREKK|^MQGATEWAY01|^TREKK|^SRVTREKK|^SECURITYTOKENSERVICE_URL")
